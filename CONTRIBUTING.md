...
issue](https://github.com/cisagov/performance-parser/issues) in
...
request](https://github.com/cisagov/performance-parser/pulls),
...
```console
cd performance-parser
pyenv virtualenv <python_version_to_use> performance-parser
pyenv local performance-parser
